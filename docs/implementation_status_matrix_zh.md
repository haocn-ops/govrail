...
| synthetic runtime checks workflow | 已實作 | [.github/workflows/synthetic-runtime-checks.yml](/Users/zh/Documents/codeX/agent_control_plane/.github/workflows/synthetic-runtime-checks.yml) | YAML parse、artifact 驗證、`npm run synthetic:artifact:validate` | 支援定時 health probe 與 production readonly verify，並固定 artifact manifest |
