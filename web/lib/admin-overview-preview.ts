import type { ControlPlaneAdminOverview } from "@/lib/control-plane-types";

export function buildAdminOverviewPreviewData(
  now = new Date().toISOString(),
): Omit<ControlPlaneAdminOverview, "contract_meta"> {
  return {
    summary: {
