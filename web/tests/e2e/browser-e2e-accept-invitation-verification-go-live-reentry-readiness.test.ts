...
const smokeExpectations = [
  {
    path: "tests/browser/onboarding-accept-invitation-verification-go-live-verification-admin-return.smoke.spec.ts",
    requiredPatterns: [
  ...
  {
    path: "tests/browser/members-accept-invitation-verification-go-live-verification-admin-return.smoke.spec.ts",
    requiredPatterns: [
...
for (const spec of smokeExpectations) {
  test(`accept-invitation verification go-live re-entry smoke keeps ${spec.path} explicit without overstating coverage`, async () => {
