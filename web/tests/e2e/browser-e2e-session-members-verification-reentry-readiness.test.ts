...
const smokeExpectations = [
  {
    path: "tests/browser/session-members-verification-settings-verification-admin-return.smoke.spec.ts",
    requiredPatterns: [
  ...
  {
    path: "tests/browser/launchpad-session-members-verification-settings-verification-admin-return.smoke.spec.ts",
    requiredPatterns: [
  ...
  {
    path: "tests/browser/session-members-verification-settings-verification-go-live-admin-return.smoke.spec.ts",
    requiredPatterns: [
  ...
  {
    path: "tests/browser/launchpad-session-members-verification-settings-verification-go-live-admin-return.smoke.spec.ts",
    requiredPatterns: [
...
for (const spec of smokeExpectations) {
  test(`session members verification re-entry smoke keeps ${spec.path} explicit without overstating coverage`, async () => {
