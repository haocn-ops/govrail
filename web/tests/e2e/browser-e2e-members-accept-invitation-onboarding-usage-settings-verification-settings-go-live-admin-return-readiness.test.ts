...
test(
  "browser readiness members->accept-invitation->onboarding->usage->manage-plan-settings->verification->settings->go-live->admin smoke keeps return continuity explicit",
  async () => {
